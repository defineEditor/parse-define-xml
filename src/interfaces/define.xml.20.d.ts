...
export type ItemGroupDefClass = 'SPECIAL PURPOSE' | 'FINDINGS' | 'EVENTS' | 'INTERVENTIONS' | 'TRIAL DESIGN' | 'RELATIONSHIP' | 'SUBJECT LEVEL ANALYSIS DATASET' | 'BASIC DATA STRUCTURE' | 'ADAM OTHER';
